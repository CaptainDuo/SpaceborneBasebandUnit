...
HD_PWD='C:/Users/86183/Desktop/Microblaze_xzjddy/Microblaze_xz_1.3/Microblaze_xz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xz_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_xz_wrapper.tcl -notrace
