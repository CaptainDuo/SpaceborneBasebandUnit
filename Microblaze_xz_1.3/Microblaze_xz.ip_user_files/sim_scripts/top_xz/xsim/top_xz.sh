...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v10_0_7 -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_14 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_17 -L fifo_generator_v13_2_2 -L axi_data_fifo_v2_1_16 -L axi_crossbar_v2_1_18 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_15 -L blk_mem_gen_v8_4_1 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_19 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top_xz xil_defaultlib.top_xz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_xz -key {Behavioral:sim_1:Functional:top_xz} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_xz.wdb xsim.dir)
