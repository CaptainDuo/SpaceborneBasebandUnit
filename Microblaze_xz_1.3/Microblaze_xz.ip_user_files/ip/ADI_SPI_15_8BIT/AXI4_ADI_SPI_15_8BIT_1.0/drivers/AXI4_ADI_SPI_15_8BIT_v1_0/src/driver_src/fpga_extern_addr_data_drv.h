...
#define		ADDR_LIST_SIZE												16						/* 定义地址数组的长度 */			
...
//导出函数
XStatus extern_addr_data_master_write(u32* addrList, u16 writeAddr, u8 writeData);
XStatus extern_addr_data_master_read(u32* addrList, u16 readAddr, u8* readData);
