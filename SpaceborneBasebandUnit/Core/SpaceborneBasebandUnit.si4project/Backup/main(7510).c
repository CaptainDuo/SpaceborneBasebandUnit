...
int8_t ad9156_parameter_initialize(SPI_HandleTypeDef *hspi,
								...
								struct ad9517_platform_data *init_pdata,
								struct ad9517_lvpecl_channel_spec *init_lvpecl, 
								struct ad9517_lvds_cmos_channel_spec *init_lvds);
...
*/
	...
	for (i = 0; i < 6; i++)
		...
		init_lvpecl[i].out_invert_en = inverting;  		//reg0xF0~0xF5[4],输出极性控制
		}
	...
	for (i = 0; i < 4; i++)
		...
		init_lvds[i].out_invert = 2; 				//reg0x140~0x143[7:5],output polarity,默认值
