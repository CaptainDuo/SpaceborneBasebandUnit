...
#
# Generated by export_simulation on Fri Sep 08 09:44:59 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './ASYNC_EMIF_SLAVE_0.sh' script.

./ASYNC_EMIF_SLAVE_0.sh -reset_run
...
./ASYNC_EMIF_SLAVE_0.sh -noclean_files

For more information on the script, please type './ASYNC_EMIF_SLAVE_0.sh -help'.
