...
HD_PWD='C:/Users/86183/Desktop/Microblaze_xzjddy/Microblaze_xz_1.4/Microblaze_xz/Microblaze_xz.runs/ASYNC_EMIF_SLAVE_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASYNC_EMIF_SLAVE_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASYNC_EMIF_SLAVE_0.tcl
